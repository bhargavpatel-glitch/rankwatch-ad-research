...
exports.runRelevanceBenchmark = runRelevanceBenchmark;
const hybridSearchEngine_1 = require("./hybridSearchEngine");
const TEST_CASES = [
    {
        query: 'Semrush',
...
function runRelevanceBenchmark() {
    console.log('====================================================');
    ...
    for (const tc of TEST_CASES) {
        ...
        const res = hybridSearchEngine_1.hybridSearchEngine.search(tc.query, { limit: 5 });
